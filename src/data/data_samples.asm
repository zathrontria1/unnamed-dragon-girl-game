...
_data_snd_smp_aryx_smp6_o02:
    ...
    section "_rodata.huge.bindata.audio.samples.44"
    global _data_snd_smp_aryx_smp5_o01
_data_snd_smp_aryx_smp5_o01:
    incbin "sound/ins/itconv/ins_aryx_smp5_o01.brr"
