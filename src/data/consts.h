...
#define ROUTINE_NEWLEVEL 3

#define ROUTINE_MSGBOX 10
#define ROUTINE_SUBSCREEN 11
#define ROUTINE_SUBSCREEN_HELP 12

#define ROUTINE_MAPDISPLAY 100
#define ROUTINE_MAPDISPLAY_INIT 101

#define ROUTINE_CUTSCENE 200
#define ROUTINE_CUTSCENE_INIT 201

#define ROUTINE_TITLE 300
#define ROUTINE_TITLE_INIT 301
#define ROUTINE_GAMEOVER 400

#define ROUTINE_FADEIN 65500
#define ROUTINE_FADEOUT 65501
#define ROUTINE_MAP_RECOVERY 65502
...
#define ENEMY_AI_MAX_PER_FRAME 1

#define OBJ_GENERAL_MAX_COUNT 40
#define OBJ_PLAYERHITBOX_MAX_COUNT 16
#define OBJ_ENEMYHITBOX_MAX_COUNT 16
...
#define AI_STATE_WANDER 4
#define AI_STATE_STRAFE 5
#define AI_STATE_DETOUR 6

#define AI_FLAG_NONE 0x00
#define AI_FLAG_ALERTED 0x01
#define AI_FLAG_LOS 0x02

#define AI_ARCHETYPE_CHASER 0
#define AI_ARCHETYPE_SKIRMISHER 1
...
/*
    ...
    4: Colour Math (COLDATA)

    6: Message box sprite enable/disable (TM)
    7: RESERVED for Vblank Odd Frame DMAs
*/
#define HDMA_USED_CHANNELS_NORMAL 0x1a
#define HDMA_USED_CHANNELS_MSGBOX 0x5e
