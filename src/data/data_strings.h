...
extern HUGE const char STR_UI_SUBSCREEN_OPTIONS_HEADING[];

extern HUGE const char STR_UI_SUBSCREEN_OPTIONS_SOUND_MODE[];
extern HUGE const char STR_UI_SUBSCREEN_OPTIONS_SOUND_MODE_STEREO[];
extern HUGE const char STR_UI_SUBSCREEN_OPTIONS_SOUND_MODE_MONO[];

extern HUGE const char STR_UI_SUBSCREEN_OPTIONS_SOUND_MVOL[];
extern HUGE const char STR_UI_SUBSCREEN_OPTIONS_SOUND_BGM_ENABLE[];
extern HUGE const char STR_UI_SUBSCREEN_OPTIONS_SOUND_SFX_ENABLE[];
extern HUGE const char STR_UI_SUBSCREEN_OPTIONS_SOUND_VOI_ENABLE[];

extern HUGE const char STR_UI_SUBSCREEN_OPTIONS_GFX_HITBLUR[];
extern HUGE const char STR_UI_SUBSCREEN_OPTIONS_GFX_HEATWAVE[];

extern HUGE const char STR_UI_SUBSCREEN_OPTIONS_ON[];
extern HUGE const char STR_UI_SUBSCREEN_OPTIONS_OFF[];

extern HUGE const char STR_UI_SUBSCREEN_OPTIONS_RETURN[];
...
extern HUGE const char STR_CRASH_ERROR_UNKNOWN[];
extern HUGE const char STR_CRASH_ERROR_MAIN_LOOP_NULL[];
extern HUGE const char STR_CRASH_ERROR_PLAYER_INSTANTIATION[];
extern HUGE const char STR_CRASH_ERROR_SPAWNER_LIST_INSTANTIATION[];
extern HUGE const char STR_CRASH_ERROR_INTERACTABLE_LIST_INSTANTIATION[];
extern HUGE const char STR_CRASH_ERROR_MAP_TOO_LARGE[];
extern HUGE const char STR_CRASH_ERROR_NPC_OUT_OF_BOUNDS[];
extern HUGE const char STR_CRASH_ERROR_SPAWNER_OUT_OF_BOUNDS[];
extern HUGE const char STR_CRASH_ERROR_INVALID_EVENT_FLAG[];
extern HUGE const char STR_CRASH_ERROR_INTERACTABLE_OUT_OF_BOUNDS[];
extern HUGE const char STR_CRASH_ERROR_INVALID_NS_DOOR_WARP[];
extern HUGE const char STR_CRASH_ERROR_INVALID_EW_DOOR_WARP[];
