...
//#define DMA_QUEUE_OVERHEAD 62 // This causes significantly increased time taken to add a queue entry due to non-power of 2 mul
...
#define OBJ_MAX_COUNT 48
#define HIT_MAX_COUNT 16
