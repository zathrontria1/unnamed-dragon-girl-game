...
set cmd_code=main.c system.c interrupt.asm interrupt_sub.c sram_management.c dma.c hdma.c asm.c math_int.c level.c loop.c loop_subscreen.c map.c obj.c movement.c routines.c routines_player.c routines_enemy.c routines_enemy_ai.c hittest.c ani.c ani_bg.c ani_fixedspr.c ani_pal.c spr.c spr_metaspr.c ui.c ui_messagebox.c snd.c lz4.c gfx.c vbcc-header-hi-ntsc.c
REM set cmd_data=vars_memory.c data_strings.c data_palette.asm data_sprite.asm data_bg.asm data_ui.asm data_snd.asm data_samples.asm
set cmd_data=vars_memory.c data_strings.c data_binary.asm
set sfc_name=main
...
vc +vlink-config -O4 -speed -maxoptpasses=128 -msfp4 -lms4 --Mmapfile --DFASTROM=1 %cmd_code% %cmd_data% -o %sfc_name%_temp.sfc
