...
set cmd_code=main.c system.c interrupt.asm interrupt_sub.c sram_management.c dma.c asm.c math_int.c level.c loop.c map.c obj.c routines.c hittest.c ani.c ani_bg.c ani_fixedspr.c ani_pal.c ani_pal_hdma.c spr.c spr_metaspr.c ui.c snd.c lz4.c gfx.c 
