...
/* This file has been slightly adapted for the vbcc compiler:
   - added REG_VMADDL/H, REG_VMDATAREADL/H/LH
   - changed u8 to vuint8 in CGRAM_PALETTE
*/
...
#define REG_VMDATAREADL (*(vuint8 *)0x2139)
#define REG_VMDATAREADH (*(vuint8 *)0x213A)
#define REG_VMDATAREADLH (*(vuint16 *)0x2139)
...
*/
#define CGRAM_PALETTE ((vuint8 *)0x2122)
